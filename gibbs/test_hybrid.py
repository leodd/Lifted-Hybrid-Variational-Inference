...
import numpy as np
from hybrid_gaussian_mrf import convert_to_bn, get_crv_marg, block_gibbs_sample
...
print('test crv marg params', test_crv_marg_params)

disc_samples, cont_samples = block_gibbs_sample(factors, rvs=None, Vd=Vd, Vc=Vc, num_burnin=100, num_samples=1000,
                                                disc_block_its=2)
